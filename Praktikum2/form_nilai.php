...
<body>
    <div class="countainer">
        ...
        <div class="col-8">
            <input id="nama" name="nama" type="text" placeholder="Masukan Nama" class="form-control">
        </div>
        </div>
        <div class="form-group row">
        ...
        <div class="col-8">
            <input id="tugas" name="tugas" type="text" placeholder="Masukan Nilai Tugas" class="form-control">
        </div>
        </div>
        <div class="form-group row">
